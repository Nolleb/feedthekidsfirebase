...
export function createAssistantrecipe(): string[] {
  return [];
}

export const assistantRecipeSchema = schema<string[]>((rootPath) => {
  applyEach(rootPath, (ingredientPath) => {
    required(ingredientPath);
  });
});
