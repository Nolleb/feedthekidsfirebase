...
export const routes: Routes = [
...

  {
    ...
    loadComponent: () =>
      import('./admin/admin-recipes/admin-recipes.component').then((m) => m.AdminRecipesComponent),
    title: 'Admin Recipes',
  },

  {
    ...
    canActivate: [adminGuard],
    loadComponent: () =>
      import('./admin/admin-recipe-edit/admin-recipe-edit.component').then(
        (m) => m.AdminRecipeEditComponent,
      ),
...

  {
    ...
    canActivate: [adminGuard],
    loadComponent: () =>
      import('./features/assistant/assistant-creator.component').then(
        (m) => m.AssistantCreatorComponent,
      ),
...

  {
    ...
    canActivate: [adminGuard],
    loadComponent: () =>
      import('./features/assistant/detail-assistant-recipe/detail-assistant-recipe.component').then(
        (m) => m.DetailAssistantRecipeComponent,
      ),
